...
bot = InstaBot(
    ...
    tag_list=['frenchbulldog', 'frenchie', 'frenchieoftheday', 'frenchie', 'frenchbull', 'fransebulldog', 'frenchiepuppy', 'dogsofinstagram', 'frenchiesgram', 'frenchbulldogsofinstagram', 'ilovemyfrenchie', 'petsagram', 'puppylove', 'bulldogsofinstagram', 'bulldog', 'frenchielife', 'frenchiesoftheworld', 'frenchiesofinstagram', 'frenchiegram', 'frenchielove', 'thefrenchiepost', 'instafrenchie', 'instadogs', 'frenchies1', 'cutepuppy', 'husky', 'corgi', 'corgination', 'pettravel', 'instadog', 'dogs_of_instagram', 'dogsofinstagram', 'dogoftheday', 'mydog', 'ilovemydog', 'pup', 'Beagle', 'Beagle', 'boxer', 'poodle', 'labradoodle', 'bostonterrier', 'pug', 'puggle', 'pitbull', 'akita', 'bloodhound', 'AustralianShepherd', 'greatdane', 'siberianhusky', 'miniatureschnauzer', 'shihtzu', 'frenchton', 'bostonterrier'], #l: for location, check example in readme.md
    tag_blacklist=['',],
